...
class LensPreparation(object):
    ...
    """
    def __init__(self,lens_model_list=['SHIFT','SHEAR','CONVERGENCE','FLEXIONFG']):
        #xdeflection,ydeflection,gamma1zl,zs,lenseq='1'):
       """
    ...
    def initial_kwargs_lens(self, x, y, kwargs_data, xdeflection, ydeflection, shift, shear, convergence




                            alphax_shift=0, alphay_shift=0, diff= 0.01):
        """
        ...
        kwargs_lens_in = [{'grid_interp_x': xaxes[0], 'grid_interp_y': yaxes[:, 0], 'f_x': alphax,
                           'f_y': alphay}]
        kwargs_lens=[]
        for lens_type in self.lens_model_list:
